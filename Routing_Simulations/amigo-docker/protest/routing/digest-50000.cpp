...
//.05 MB:
// n = 200
// p = 0.00001 (1 in 99923)
// m = 4793 (599B)
// k = 17

const uint32_t bloomSize = 4793;
const uint32_t subset_size = 1450;
const uint32_t hashes = 17;

const int maxBufferSize = 50000; // (.05MB) largest buffer that a node can have stored locally; value set from command line
